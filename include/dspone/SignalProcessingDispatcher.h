...
/**
	 * @brief The SignalProcessingDispatcher to have a teplate
...
class SignalProcessingDispatcher
{
    public:

	SignalProcessingDispatcher(){}
	virtual ~SignalProcessingDispatcher(){}
	...
	{
	    return static_cast<Derived*>(this)->process(signal, inbuffersize, output, outbuffersize);
	}
	 ...
	 * @return   the number of channels to process.
	 */
...
/**
	 ...
	 */
template<class Derived>
class SignalAnalysisDispatcher
{
    public:

	SignalAnalysisDispatcher(){}
	virtual ~SignalAnalysisDispatcher(){}
