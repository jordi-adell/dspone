...
void FilterBank::filterBuffer(int16_t *inbuffer, int16_t *residual, int16_t *outbuffer, int inlength, int outlength)
{
  filterBufferCore(inbuffer, residual, outbuffer, inlength, outlength);
}

void FilterBank::filterBuffer(double *inbuffer, double *residual, double *outbuffer, int inlength, int outlength)
{
  filterBufferCore(inbuffer, residual, outbuffer, inlength, outlength);
}

void FilterBank::filterBuffer(float *inbuffer, float *residual, float *outbuffer, int inlength, int outlength)
{
  filterBufferCore(inbuffer, residual, outbuffer, inlength, outlength);
}
...
template <class T> void FilterBank::filterBufferCore(T *inbuffer, T *residual, T *outbuffer, int inlength, int outlength)
{
  ...
  wipp::copyBuffer(inbuffer, residual, inlength);
